...
\ifans\fbox{$\displaystyle \sin{\theta}=\frac{\sqrt{2}}{2}$, $\displaystyle \cos{\theta}=\frac{\sqrt{2}}{2}$, $\displaystyle \tan{\theta}=1$, $\displaystyle \sec{\theta}=\sqrt{2}$, and $\displaystyle \cot{\theta}=1$}\fi
