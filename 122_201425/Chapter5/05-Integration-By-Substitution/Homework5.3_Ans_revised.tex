...
\includegraphics[scale=0.5]{start.pdf}
{{{1\linewidth}{$\frac{1}{2}(1-x^{4})^{\frac{3}{2}}+C$; %Detailed Solution: \textcolor{blue}{\href{http://www.math.drexel.edu/classes/Calculus/resources/Math122HW/Solutions/122_05_Substitution_10.pdf}{Here}}\\
...
\includegraphics[scale=0.5]{start.pdf}
{{$\frac{1}{2\sqrt{2}}\arctan{(\sqrt{2}x)}+C$; Video Solution: \textcolor{blue}{\href{http://www.youtube.com/watch?v=HVA-eDtKsG4}{http://www.youtube.com/watch?v=HVA-eDtKsG4}} %Detailed Solution: \textcolor{blue}{\href{http://www.math.drexel.edu/classes/Calculus/resources/Math122HW/Solutions/122_05_Substitution_12.pdf}{Here}}
}}
\includegraphics[scale=0.5]{end.pdf}
