...
\includegraphics[scale=0.5]{start.pdf}
{{\bf NOTE:} In number 18, we could have considered $f(x)=1+x$.  In that case, $[a,b]=[0,4]$ and $\lim_{n \rightarrow +\infty} \sum_{k=1}^n{\left(1+\frac{4}{n}k\right)\frac{4}{n}}=\int_0^4{(1+x)} \,dx$.  The value of this definite integral is also 12.}
\includegraphics[scale=0.5]{end.pdf}
