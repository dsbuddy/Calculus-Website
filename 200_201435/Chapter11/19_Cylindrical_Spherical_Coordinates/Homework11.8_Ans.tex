...
\fbox{$(\rho, \theta, \phi)=\left(\sqrt{5}, \frac{\pi}{2}, \cos^{-1}\frac{1}{\sqrt{5}}\right)$}
...
\fbox{$(x,y,z)=\left(\frac{\sqrt{2}}{2},\frac{\sqrt{2}}{2},-4\right)$}

\item Convert this point to spherical coordinates.

\fbox{$(\rho, \theta, \phi)=\left(\sqrt{17}, \frac{\pi}{4}, \cos^{-1}\left(-\frac{4}{\sqrt{17}}\right)\right)$}
...
\fbox{$(x,y,z)=\left(\frac{5\sqrt{3}}{4},\frac{15}{4},-\frac{5}{2}\right)$}

\item Convert this point to cylindrical coordinates.

\fbox{$(r, \theta, z)=\left(\frac{5\sqrt{3}}{2}, \frac{\pi}{3}, -\frac{5}{2}\right)$}
...
\fbox{$(r, \theta, z)=\left(2, \frac{5\pi}{3}, -2\right)$}

\item Convert this point to spherical coordinates.

\fbox{$(\rho, \theta, \phi)=\left(\sqrt{8}, \frac{5\pi}{3}, \frac{3\pi}{4}\right)$}
...
\fbox{(a)$r^2+z^2=16$; (b) $\rho=4$}

\item $x^2+y^2+z^2=3z$

\fbox{(a)$r^2+z^2=3z$; (b) $\rho=3\cos{\phi}$}

\item $z=\sqrt{2x^2+2y^2}$

\fbox{(a)$z=\sqrt{2}r$; (b) $\phi=\cos^{-1}\left(\frac{2}{\sqrt{6}}\right)$}

\item $x^2+y^2=9$

\fbox{(a)$r=3$; (b) $\rho\sin{\phi}=3$}

\item $x+3y+5z=4$

\fbox{(a)$r\cos{\theta}+3r\sin{\theta}+5z=4$; (b) $\rho\cos{\theta}\sin{\phi}+3\rho\sin{\theta}\sin{\phi}+5\rho\cos{\phi}=4$}

\item $z=2$

\fbox{(a)$z=2$; (b) $\rho\cos{\phi}=2$}
...
\fbox{$z=\frac{1}{\sqrt{3}}\sqrt{x^2+y^2}$}

\item $\rho=4\cos{\phi}$

\fbox{$x^2+y^2+(z-2)^2=4$}
...
\fbox{\parbox{1\linewidth}{All points in the first octant which are on or inside of the circular cylinder $x^2+y^2=4$ between the planes $z=0$, $z=1$, $y=0$ and $y=\sqrt{3}x$.
\begin{center}
...
\fbox{\parbox{1\linewidth}{All points in the first octant which are on and between the spheres $x^2+y^2+z^2=1$ and $x^2+y^2+z^2=9$, on and between the planes $x=0$ and $y=0$, and on or within the cone $z=\sqrt{x^2+y^2}$.}}
