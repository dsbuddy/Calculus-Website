...
\includegraphics[scale=0.5]{start.pdf}
{{{1\linewidth}{The curve is a helix on the cylinder $x^2+y^2=16$ which climbs from the point $(4,0,0)$ to the point $(4,0,4\pi)$
\begin{center}
...
\includegraphics[scale=0.5]{start.pdf}
{{\includegraphics[scale=0.3]{parabola.pdf}}}
\includegraphics[scale=0.5]{end.pdf}
...
\includegraphics[scale=0.5]{start.pdf}
{{{1\linewidth}{${\bf T}(t)=\left\langle -\frac{2}{\sqrt{5}}\sin{t}, \frac{1}{\sqrt{5}}, \frac{2}{\sqrt{5}}\cos{t}\right\rangle$; ${\bf N}(t)=\left\langle -\cos{t}, 0, -\sin{t}\right\rangle$; \\
