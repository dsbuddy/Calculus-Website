...
\fbox{$L(x,y)=3-3\ln{3}+3x$}

\item $f(x,y)=\ln{(x^2-y^2)}$; $P\left(2,\sqrt{3}\right)$

\fbox{$L(x,y)=-2+4x-2\sqrt{3}y$}

\item $f(x,y)=\tan^{-1}\left(\frac{x}{y}\right)$; $P(1,1)$

\fbox{$L(x,y)=\frac{\pi}{4}+\frac{1}{2}x-\frac{1}{2}y$; Detailed Solution: \textcolor{blue}{\href{http://www.math.drexel.edu/classes/Calculus/resources/Math200HW/Solutions/14_200_LLA_05.pdf}{Here}}}
...
\fbox{\parbox{0.65\linewidth}{$f(x,y)\approx L(x,y)=\frac{32}{5}-\frac{3}{5}x-\frac{2}{5}y$ for $(x,y)$ near $(1,2)$.\\
\\
...
\fbox{\parbox{0.65\linewidth}{$f(x,y)\approx L(x,y)=-3+5x-2y$ for $(x,y)$ near $(2,3)$.\\
...
\fbox{$L(x,y,z)=8-5x-8y-3z$}

\item Verify that $e^x\cos{y} \approx 1+x$ for $(x,y)$ near $(0,0)$.

\fbox{\parbox{1\linewidth}{Show that the local linear approximation to $f(x,y)=e^x\cos{y}$ at the point $(0,0)$ is $L(x,y)=1+x$}}

\item Verify that $(x+y)^3 \approx -16+12x+12y$ for $(x,y)$ near $(1,1)$.

\fbox{\parbox{1\linewidth}{Show that the local linear approximation to $f(x,y)=(x+y)^3$ at the point $(1,1)$ is $L(x,y)=-16+12x+12y$}}
...
\fbox{$(2,3)$; Detailed Solution: \textcolor{blue}{\href{http://www.math.drexel.edu/classes/Calculus/resources/Math200HW/Solutions/14_200_LLA_11.pdf}{Here}}}
