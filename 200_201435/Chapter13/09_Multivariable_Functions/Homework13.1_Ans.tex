...
\ifans{\fbox{\parbox{1\linewidth}{The domain is all points in the $xy$-plane which are on or inside of $x^2+y^2=10$, the circle with a radius of $\sqrt{10}$ centered at the origin.
\begin{center}
...
\ifans{\fbox{\parbox{1\linewidth}{The domain is all points in the $xy$ plane which are between the lines $y=-2x-1$ and $y=-2x+1$, including the points on the lines.\\
\begin{center}
...
\ifans{\fbox{\parbox{1\linewidth}{All point in 3-space which are inside of (but not on) the ellipsoid $\frac{x^2}{9}+\frac{y^2}{4}+z^2=1$.
\begin{center}
...
\ifans{\fbox{All points in 3-space which are on or below the plane $2x+3y+z=6$}} \fi
...
\ifans{\fbox{\parbox{0.7\linewidth}{\begin{center}
...
\ifans{\fbox{$f(x(t),y(t))=f\left(\frac{\sqrt{2}}{2}t,\frac{\sqrt{2}}{2}t\right)=t^2$}} \fi
