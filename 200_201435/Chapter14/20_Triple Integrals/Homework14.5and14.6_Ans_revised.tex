...
\includegraphics[scale=0.5]{start.pdf}
{{$V_M=\int_{-\sqrt{2}}^{\sqrt{2}} \int_{-\sqrt{2-x^2}}^{\sqrt{2-x^2}} \int_{\sqrt{x^2+y^2}}^{\sqrt{4-x^2-y^2}} 1 \,dz\,dy\,dx$}}
\includegraphics[scale=0.5]{end.pdf}
...
\includegraphics[scale=0.5]{start.pdf}
{{$V_M=\int_0^{2\pi} \int_0^{\sqrt{2}} \int_r^{\sqrt{4-r^2}} r\,dz\,dr\,d\theta$}}
\includegraphics[scale=0.5]{end.pdf}
...
\includegraphics[scale=0.5]{start.pdf}
{{$V_M=\int_0^{\pi/4} \int_0^{2\pi} \int_0^2 \rho^2 \sin{\phi} \,d\rho \,d\theta \,d\phi$}}
\includegraphics[scale=0.5]{end.pdf}
...
\includegraphics[scale=0.5]{start.pdf}
{{$V_L=\int_{-1}^{1} \int_{-\sqrt{1-x^2}}^{\sqrt{1-x^2}} \int_{\sqrt{x^2+y^2}}^{2-x^2-y^2} 1 \,dz\,dy\,dx$}}
\includegraphics[scale=0.5]{end.pdf}
...
\includegraphics[scale=0.5]{start.pdf}
{{$V_L=\int_0^{2\pi} \int_0^{1} \int_r^{2-r^2} r\,dz\,dr\,d\theta$}}
\includegraphics[scale=0.5]{end.pdf}
...
\includegraphics[scale=0.5]{start.pdf}
{{{1\linewidth}{$V_M=\frac{16\pi}{3}\left(1-\frac{\sqrt{2}}{2}\right)\approx 4.907$; $V_L=\frac{5\pi}{6}\approx 2.618$; So, Mario's ice cream cones have the larger volume.}}}
\includegraphics[scale=0.5]{end.pdf}
