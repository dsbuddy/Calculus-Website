...
\begin{tabular}{cc|cc}
(a) && (i)&\\
&\includegraphics[scale=0.218]{match1.pdf}& & \includegraphics[scale=0.218]{matchd.pdf}\\
(b) && (ii)&\\
...
(d) && (iv)&\\
&\includegraphics[scale=0.218]{match4.pdf} & & \includegraphics[scale=0.218]{matchb.pdf}
\end{tabular}
\end{center}
\ifans{\fbox{Answer:
\begin{tabular}{|c|c|}
