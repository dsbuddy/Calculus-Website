...
\includegraphics[scale=0.5]{start.pdf}
{{{1\linewidth}{$A\approx 118$; This is an overestimate; but, it is closer to the actual area than the estmate from part (a).}}}
\includegraphics[scale=0.5]{end.pdf}
...
\includegraphics[scale=0.5]{start.pdf}
{{$\lim_{n\rightarrow +\infty}A(n)=78$.  This is the exact area between the graph of $f(x)$ and the $x$-axis on $[0,6]$}}
\includegraphics[scale=0.5]{end.pdf}
